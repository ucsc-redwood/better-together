...
local ANDROID_CONFIG = {
	...
	ignored_devices = { "ZY22FLDDK7", "ce0717178d7758b00b7e", "R5CY21Y3VEV" },
...
if is_plat("android") then
	...
	add_versions("v1.9.2", "afa23b7699c17f1e26c88cbf95257b20d78d6247")
	...
	add_urls(
		"https://github.com/CLIUtils/CLI11/archive/refs/tags/$(version).tar.gz",
...
on_run(function()
	...
	for i, device_id in ipairs(devices) do
		...
		os.execv("adb", {
			...
			"mkdir -p "
				.. remote_path
				.. "/resources && tar --no-same-owner -xzvf "
				.. remote_path
				.. "/resources.tar.gz -C "
				.. remote_path
				.. "/resources",
