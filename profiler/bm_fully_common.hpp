...
#include "platform/registry/device_registry.hpp"  // ProcessorType, g_*_cores, has_*_cores, get_cpu_cores_by_type
#include "table.hpp"

#ifdef __CUDACC__
#include "platform/engine/cuda/helpers.cuh"  // CheckCuda (CudaEventTimer)
#endif
