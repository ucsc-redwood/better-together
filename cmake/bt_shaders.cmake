...
function(bt_bake_shaders)
  ...
  if(NOT BT_GLSLC OR NOT BT_XXD)
    message(STATUS "Shader bake: glslc/xxd not both found -> using committed *_spv.h as-is "
  ...
  foreach(comp ${comps})
    ...
    add_custom_command(
      ...
      COMMAND ${BT_GLSLC} --target-env=vulkan1.3 -O -fshader-stage=compute -o ${spv} ${comp}
      COMMAND ${CMAKE_COMMAND} -E chdir ${sdir}/spv
              sh -c "{ echo '#pragma once'; ${BT_XXD} -i ${name}.spv; } > ${hdr}"
      DEPENDS ${comp}
