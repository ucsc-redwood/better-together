...
class CudaDispatcher {
 public:
  ...
  void run_stage_3_async(cifar_sparse::AppData &appdata);
  void run_stage_4_async(cifar_sparse::AppData &appdata);
  void run_stage_5_async(cifar_sparse::AppData &appdata);
  void run_stage_6_async(cifar_sparse::AppData &appdata);
