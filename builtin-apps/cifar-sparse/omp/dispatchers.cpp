...
void run_stage_1_task_stealing(cifar_sparse::v2::AppData &appdata) {
  LOG_KERNEL(LogKernelType::kOMP, 1, &appdata);
  ...
  v2::conv2d_omp_batched_task_stealing(appdata.u_input.data(),
                                       batch_size,   // 128
                                       in_channels,  // 3
                                       in_height,    // 32
                                       in_width,     // 32
...
void run_stage_2_task_stealing(cifar_sparse::v2::AppData &appdata) {
  LOG_KERNEL(LogKernelType::kOMP, 2, &appdata);
  ...
  // Call the clean batched max pool kernel.
  maxpool2d_omp_batched_clean_task_stealing(appdata.u_conv1_out.data(),  // input_data pointer
                                            batch_size,                  // number of images
                                            channels,   // number of channels per image
                                            in_height,  // height of the input feature map
                                            in_width,   // width of the input feature map
...
void run_stage_3_task_stealing(cifar_sparse::v2::AppData &appdata) {
  LOG_KERNEL(LogKernelType::kOMP, 3, &appdata);
  ...
  v2::conv2d_omp_batched_task_stealing(appdata.u_pool1_out.data(),
                                       batch_size,   // 128
                                       in_channels,  // 16
                                       in_height,    // 16
                                       in_width,     // 16
...
void run_stage_4_task_stealing(cifar_sparse::v2::AppData &appdata) {
  LOG_KERNEL(LogKernelType::kOMP, 4, &appdata);
  ...
  // Call the clean batched max pool kernel
  maxpool2d_omp_batched_clean_task_stealing(appdata.u_conv2_out.data(),  // input_data pointer
                                            batch_size,                  // number of images
                                            channels,   // number of channels per image
                                            in_height,  // height of the input feature map
                                            in_width,   // width of the input feature map
...
void run_stage_5_task_stealing(cifar_sparse::v2::AppData &appdata) {
  LOG_KERNEL(LogKernelType::kOMP, 5, &appdata);
  ...
  v2::conv2d_omp_batched_task_stealing(appdata.u_pool2_out.data(),
                                       batch_size,   // 128
                                       in_channels,  // 32
                                       in_height,    // 8
                                       in_width,     // 8
...
void run_stage_6_task_stealing(cifar_sparse::v2::AppData &appdata) {
  LOG_KERNEL(LogKernelType::kOMP, 6, &appdata);
  ...
  v2::conv2d_omp_batched_task_stealing(appdata.u_conv3_out.data(),
                                       batch_size,   // 128
                                       in_channels,  // 64
                                       in_height,    // 8
                                       in_width,     // 8
...
void run_stage_7_task_stealing(cifar_sparse::v2::AppData &appdata) {
  LOG_KERNEL(LogKernelType::kOMP, 7, &appdata);
  ...
  v2::conv2d_omp_batched_task_stealing(appdata.u_conv4_out.data(),
                                       batch_size,   // 128
                                       in_channels,  // 64
                                       in_height,    // 8
                                       in_width,     // 8
...
void run_stage_8_task_stealing(cifar_sparse::v2::AppData &appdata) {
  LOG_KERNEL(LogKernelType::kOMP, 8, &appdata);
  ...
  // Call the clean batched max pool kernel
  maxpool2d_omp_batched_clean_task_stealing(appdata.u_conv5_out.data(),  // input_data pointer
                                            batch_size,                  // number of images
                                            channels,   // number of channels per image
                                            in_height,  // height of the input feature map
                                            in_width,   // width of the input feature map
...
void run_stage_9_task_stealing(cifar_sparse::v2::AppData &appdata) {
  LOG_KERNEL(LogKernelType::kOMP, 9, &appdata);
  ...
  // Use the batched sparse linear layer kernel
  v2::linear_omp_batched_task_stealing(appdata.u_pool3_out.data(),  // Input data (flattened 4D->2D)
                                       batch_size,                  // 128
                                       input_features,              // 1024
                                       appdata.linear_sparse.values_data(),
                                       appdata.linear_sparse.row_ptr_data(),
