...
//   // input_features]) layout(std430, set = 0, binding = 2) readonly buffer WeightValsBuffer {
//   float
//   // weight_vals[]; };

//   // // CSR row pointers: length = out_neurons + 1.
//   // layout(std430, set = 0, binding = 3) readonly buffer WeightRowPtrBuffer { int
//   weight_row_ptr[];
//   // };

//   // // CSR column indices: flat indices of nonzero weight locations (i.e. input feature
//   indices).
//   // layout(std430, set = 0, binding = 4) readonly buffer WeightColIdxBuffer { int
//   weight_col_idx[];
//   // };
