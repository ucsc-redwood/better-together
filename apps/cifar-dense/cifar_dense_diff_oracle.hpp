...
// conv accumulates up to 384*3*3=3456 terms (and the FC head 4096 terms) per
// output against a double-precision reference, so OMP/CUDA (IEEE fp32) can be
// held tight while Vulkan (relaxed-precision shaders) needs a looser bound; e2e
// is looser still because float error accumulates across all 11 stages.
...
inline void CheckPool(
  ...
  const auto r = ref::MaxPool2dRef(in.data(),
                                   ...
                                   out.d2(),
                                   out.d3(),
                                   cifar_dense::kPoolSize,
                                   cifar_dense::kPoolStride);
  EXPECT_TRUE(bt::testing::NearEqual(r, out.pmr_vec(), rtol, atol, name));
}
...
inline void CheckStage(const AppData& a, int s, float rtol, float atol) {
  switch (s) {
    case 1:
      CheckConv(
          "cifar-dense conv1", a.u_input, a.u_conv1_w, a.u_conv1_b, a.u_conv1_out, rtol, atol);
      break;
    case 2:
      CheckPool("cifar-dense pool1", a.u_conv1_out, a.u_pool1_out, rtol, atol);
      break;
    case 3:
      CheckConv(
          "cifar-dense conv2", a.u_pool1_out, a.u_conv2_w, a.u_conv2_b, a.u_conv2_out, rtol, atol);
      break;
    case 4:
      CheckPool("cifar-dense pool2", a.u_conv2_out, a.u_pool2_out, rtol, atol);
      break;
    case 5:
      CheckConv(
          "cifar-dense conv3", a.u_pool2_out, a.u_conv3_w, a.u_conv3_b, a.u_conv3_out, rtol, atol);
      break;
    case 6:
      CheckConv(
          "cifar-dense conv4", a.u_conv3_out, a.u_conv4_w, a.u_conv4_b, a.u_conv4_out, rtol, atol);
      break;
    case 7:
      CheckConv(
          "cifar-dense conv5", a.u_conv4_out, a.u_conv5_w, a.u_conv5_b, a.u_conv5_out, rtol, atol);
      break;
    case 8:
      CheckPool("cifar-dense pool3", a.u_conv5_out, a.u_pool3_out, rtol, atol);
      break;
    case 9:
      CheckLinear(
          "cifar-dense fc1", a.u_pool3_out, a.u_fc1_w, a.u_fc1_b, a.u_fc1_out, kRelu, rtol, atol);
      break;
    case 10:
      CheckLinear(
          "cifar-dense fc2", a.u_fc1_out, a.u_fc2_w, a.u_fc2_b, a.u_fc2_out, kRelu, rtol, atol);
      break;
    case 11:
      CheckLinear("cifar-dense fc3 (logits)",
                  a.u_fc2_out,
                  a.u_fc3_w,
                  a.u_fc3_b,
                  a.u_fc3_out,
      ...
      break;
    default:
      FAIL() << "no such cifar-dense stage: " << s;
  }
}
...
// ----------------------------------------------------------------------------
// L2a: end-to-end. Run the whole pipeline (stages 1..11) on the backend, then
...
inline void CheckFinalPipeline(const AppData& a, float rtol, float atol) {
  ...
  EXPECT_TRUE(bt::testing::NearEqual(
      logits, a.u_fc3_out.pmr_vec(), rtol, atol, "cifar-dense end-to-end logits"));
}
...
#define BT_DECLARE_CIFAR_DENSE_DIFF_TESTS(SUITE, RUNNER)                           \
  ...
  TEST(SUITE, Stage9_FC1) { cifar_dense::testing::RunAndCheckStage<RUNNER>(9); }   \
  TEST(SUITE, Stage10_FC2) { cifar_dense::testing::RunAndCheckStage<RUNNER>(10); } \
  TEST(SUITE, Stage11_FC3) { cifar_dense::testing::RunAndCheckStage<RUNNER>(11); } \
