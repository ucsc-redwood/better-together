...
| [`architecture.html`](architecture.html) | Visual **as-is** architecture snapshot (open in a browser): the 3-tool pipeline, runtime layering + backend fan-out, app stage matrix, build-migration status, debt annotations |
