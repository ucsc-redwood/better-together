...
struct DeviceModelData {
  explicit DeviceModelData(const cifar_dense::ModelData& h_model_data) : h_model_ref(h_model_data) {
    ...
    CheckCuda(cudaMemcpy(d_conv1_w,
                         h_model_data.h_conv1_w.raw(),
                         h_model_data.h_conv1_w.memory_usage_bytes(),
                         cudaMemcpyHostToDevice));
    CheckCuda(cudaMemcpy(d_conv1_b,
                         h_model_data.h_conv1_b.raw(),
                         h_model_data.h_conv1_b.memory_usage_bytes(),
                         cudaMemcpyHostToDevice));
    CheckCuda(cudaMemcpy(d_conv2_w,
                         h_model_data.h_conv2_w.raw(),
                         h_model_data.h_conv2_w.memory_usage_bytes(),
                         cudaMemcpyHostToDevice));
    CheckCuda(cudaMemcpy(d_conv2_b,
                         h_model_data.h_conv2_b.raw(),
                         h_model_data.h_conv2_b.memory_usage_bytes(),
                         cudaMemcpyHostToDevice));
    CheckCuda(cudaMemcpy(d_conv3_w,
                         h_model_data.h_conv3_w.raw(),
                         h_model_data.h_conv3_w.memory_usage_bytes(),
                         cudaMemcpyHostToDevice));
    CheckCuda(cudaMemcpy(d_conv3_b,
                         h_model_data.h_conv3_b.raw(),
                         h_model_data.h_conv3_b.memory_usage_bytes(),
                         cudaMemcpyHostToDevice));
    CheckCuda(cudaMemcpy(d_conv4_w,
                         h_model_data.h_conv4_w.raw(),
                         h_model_data.h_conv4_w.memory_usage_bytes(),
                         cudaMemcpyHostToDevice));
    CheckCuda(cudaMemcpy(d_conv4_b,
                         h_model_data.h_conv4_b.raw(),
                         h_model_data.h_conv4_b.memory_usage_bytes(),
                         cudaMemcpyHostToDevice));
    CheckCuda(cudaMemcpy(d_conv5_w,
                         h_model_data.h_conv5_w.raw(),
                         h_model_data.h_conv5_w.memory_usage_bytes(),
                         cudaMemcpyHostToDevice));
    CheckCuda(cudaMemcpy(d_conv5_b,
                         h_model_data.h_conv5_b.raw(),
                         h_model_data.h_conv5_b.memory_usage_bytes(),
                         cudaMemcpyHostToDevice));
    CheckCuda(cudaMemcpy(d_linear_w,
                         h_model_data.h_linear_w.raw(),
                         h_model_data.h_linear_w.memory_usage_bytes(),
                         cudaMemcpyHostToDevice));
    CheckCuda(cudaMemcpy(d_linear_b,
                         h_model_data.h_linear_b.raw(),
                         h_model_data.h_linear_b.memory_usage_bytes(),
                         cudaMemcpyHostToDevice));
