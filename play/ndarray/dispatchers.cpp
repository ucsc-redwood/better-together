...
void run_stage_2(AppData& appdata) { maxpool2d(appdata.conv1_out, 2, 2, appdata.pool1_out); }
...
void run_stage_4(AppData& appdata) { maxpool2d(appdata.conv2_out, 2, 2, appdata.pool2_out); }
...
void run_stage_8(AppData& appdata) { maxpool2d(appdata.conv5_out, 2, 2, appdata.pool3_out); }
