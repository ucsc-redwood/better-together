...
BENCHMARK(BM_baseline_omp)->Unit(benchmark::kMillisecond)->Name("OMP/CIFAR-Dense/Baseline");
...
BENCHMARK(BM_baseline_cuda)->Unit(benchmark::kMillisecond)->Name("CUDA/CIFAR-Dense/Baseline");
