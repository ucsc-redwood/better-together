...
speedups = {
    "3A021JEHN02756": {
        "cifar-dense": {
            "cpu": baseline_times["3A021JEHN02756"]["cifar-dense"]["cpu"] / get_best_predicted_time(cifar_dense_3a021jehn02756_df),
            "gpu": baseline_times["3A021JEHN02756"]["cifar-dense"]["gpu"] / get_best_predicted_time(cifar_dense_3a021jehn02756_df),
        },
        "cifar-sparse": {
            "cpu": baseline_times["3A021JEHN02756"]["cifar-sparse"]["cpu"] / get_best_predicted_time(cifar_sparse_3a021jehn02756_df),
            "gpu": baseline_times["3A021JEHN02756"]["cifar-sparse"]["gpu"] / get_best_predicted_time(cifar_sparse_3a021jehn02756_df),
        },
        "tree": {
            "cpu": baseline_times["3A021JEHN02756"]["tree"]["cpu"] / get_best_predicted_time(tree_3a021jehn02756_df),
            "gpu": baseline_times["3A021JEHN02756"]["tree"]["gpu"] / get_best_predicted_time(tree_3a021jehn02756_df),
        },
    },
    "9b034f1b": {
        "cifar-dense": {
            "cpu": baseline_times["9b034f1b"]["cifar-dense"]["cpu"] / get_best_predicted_time(cifar_dense_9b034f1b_df),
            "gpu": baseline_times["9b034f1b"]["cifar-dense"]["gpu"] / get_best_predicted_time(cifar_dense_9b034f1b_df),
        },
        "cifar-sparse": {
            "cpu": baseline_times["9b034f1b"]["cifar-sparse"]["cpu"] / get_best_predicted_time(cifar_sparse_9b034f1b_df),
            "gpu": baseline_times["9b034f1b"]["cifar-sparse"]["gpu"] / get_best_predicted_time(cifar_sparse_9b034f1b_df),
        },
        "tree": {
            "cpu": baseline_times["9b034f1b"]["tree"]["cpu"] / get_best_predicted_time(tree_9b034f1b_df),
            "gpu": baseline_times["9b034f1b"]["tree"]["gpu"] / get_best_predicted_time(tree_9b034f1b_df),
        },
    },
    "jetson": {
        "cifar-dense": {
            "cpu": baseline_times["jetson"]["cifar-dense"]["cpu"] / get_best_predicted_time(jetson_cifar_dense_cu_df),
            "gpu": baseline_times["jetson"]["cifar-dense"]["gpu"] / get_best_predicted_time(jetson_cifar_dense_cu_df),
        },
        "cifar-sparse": {
            "cpu": baseline_times["jetson"]["cifar-sparse"]["cpu"] / get_best_predicted_time(jetson_cifar_sparse_cu_df),
            "gpu": baseline_times["jetson"]["cifar-sparse"]["gpu"] / get_best_predicted_time(jetson_cifar_sparse_cu_df),
        },
        "tree": {
            "cpu": baseline_times["jetson"]["tree"]["cpu"] / get_best_predicted_time(jetson_tree_cu_df),
            "gpu": baseline_times["jetson"]["tree"]["gpu"] / get_best_predicted_time(jetson_tree_cu_df),
        },
    }
}
...
cpu_speedups = [speedups[device][app]['cpu'] 
                for device in speedups 
                for app in speedups[device]]
gpu_speedups = [speedups[device][app]['gpu'] 
                for device in speedups 
                for app in speedups[device]]
