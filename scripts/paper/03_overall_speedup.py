...
for app in apps:
    ...
    legend_elements.append(mpatches.Patch(facecolor=app_colors[app], edgecolor='black', 
                                        hatch=hatch_patterns["CPU"], label=f'{app} (vs. CPU)'))
    legend_elements.append(mpatches.Patch(facecolor=app_colors[app], edgecolor='black', 
                                        hatch=hatch_patterns["GPU"], label=f'{app} (vs. GPU)'))
