...
measured = np.array([
    7.12, 5.54, 7.51, 9.70, 8.02, 8.29, 6.67, 8.23, 5.77, 6.01,
    8.24, 9.83, 7.00, 12.35, 8.65, 7.27, 7.37, 17.37, 35.15, 42.99
])

predicted = np.array([
    7.83, 8.67, 8.67, 9.43, 9.58, 9.58, 9.58, 9.58, 9.58, 9.58,
    9.74, 10.22, 10.60, 11.43, 11.43, 11.43, 12.45, 20.24, 34.32, 42.20
])
