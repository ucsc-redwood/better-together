#!/usr/bin/env python3
"""
Main orchestrator for schedule parsing and analysis.

This script coordinates the parsing of log files, calculation of statistics,
model comparison, and visualization generation.
"""
...
from .log_parser import find_log_files, process_log_file
